...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
							...
							<!-- Image -->
								<section>
									...
									<div class="box alt">
										<div class="row gtr-uniform">
											<div class="col-12"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic04.jpg') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic01.jpg') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic02.jpg') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic03.jpg') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic03.jpg') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic01.jpg') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic02.jpg') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('/hyperspace/images/pic02.jpg') }}" alt="" /></span></div>
