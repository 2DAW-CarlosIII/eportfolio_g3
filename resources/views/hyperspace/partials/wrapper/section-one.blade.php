<section id="one" class="wrapper style2 spotlights">
    <section>
        <a href="#" class="image"><img src="{{ asset('/hyperspace/images/pic01.jpg') }}" alt=""
    ...
    <section>
        <a href="#" class="image"><img src="{{ asset('/hyperspace/images/pic02.jpg') }}" alt=""
    ...
    <section>
        <a href="#" class="image"><img src="{{ asset('/hyperspace/images/pic03.jpg') }}" alt=""
