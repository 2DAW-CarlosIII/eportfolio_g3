                ...
                <div class="card-body" style="padding:30px">
                    ...
                    <form action="{{ action([App\Http\Controllers\FamiliasProfesionalesController::class, 'update'], ['id' => $id]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control" value="{{ $familias-profesionales['nombre'] }}">
                        </div>

                        <div class="form-group">
                            <label for="docente_id">Docente</label>
                            <input type="number" name="docente_id" id="docente_id" value="{{ $familias-profesionales['docente_id'] }}>
                        </div>

                        <div class="form-group">
                            <label for="dominio">Dominio</label><br />
                            https://github.com/2DAW-CarlosIII/
                            <input type="text" name="dominio" id="dominio" class="form-control" value="{{ $familias-profesionales['dominio'] }}>
                        </div>
