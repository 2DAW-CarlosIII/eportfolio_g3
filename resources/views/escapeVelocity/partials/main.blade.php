...
<section id="main" class="wrapper style2">
    ...
    <div class="container">
        ...
        <a href="#" class="image featured">
            <img src="{{ asset('/escapeVelocity/images/pic01.jpg') }}" alt="" />
        </a>
        ...
        <div class="row aln-center">
            <div class="col-4 col-12-medium">
                <section class="highlight">
                    <a href="#" class="image featured"><img src="{{ asset('/escapeVelocity/images/pic02.jpg') }}"
                            alt="" /></a>
                    <h3><a href="#">Aliquam diam consequat</a></h3>
                    <p>Eget mattis at, laoreet vel amet sed velit aliquam diam ante, dolor aliquet sit amet vulputate
                        mattis amet laoreet lorem.</p>
                    <ul class="actions">
            ...
            <div class="col-4 col-12-medium">
                <section class="highlight">
                    <a href="#" class="image featured"><img src="{{ asset('/escapeVelocity/images/pic03.jpg') }}"
                            alt="" /></a>
            ...
            <div class="col-4 col-12-medium">
                <section class="highlight">
                    <a href="#" class="image featured"><img src="{{ asset('/escapeVelocity/images/pic04.jpg') }}"
                            alt="" /></a>
