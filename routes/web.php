...
Route::group(['middleware' => 'auth'], function () {
    ...
    //Criterios de evaluación ----------
        ...
        Route::get('edit/{id}', [CriteriosEvaluacionController::class, 'getEdit'])
            ->where('id', '[0-9]+');
        Route::put('update/{id}', [CriteriosEvaluacionController::class, 'update'])
            ->where('id', '[0-9]+');
    ...
    //Resultados de aprendizaje ----------
        ...
        Route::get('edit/{id}', [ResultadosAprendizajesController::class, 'getEdit'])
            ->where('id', '[0-9]+');
        Route::put('update/{id}', [ResultadosAprendizajesController::class, 'update'])
            ->where('id', '[0-9]+');
    });
